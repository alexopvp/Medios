...
function draw() {
  ...
  fruto.dibujarse();
  fruto.esComida();
  //Funciones de morirse para roberto
    ...
    for (var f = 0; f < numeroFrutas; f++)
  {
   frutas[f].dibujarse();
    ...
    {
     if (dist(frutas[f].posXfru,frutas[f].posYfru,lasCucarachas[cf].posXCuc,lasCucarachas[cf].posYCuc)<15)
     {
      frutas[f].esComida(); 
     }
    }
  }
  //Funciones de gusanos
  for (var g = 0; g < numeroDeWorms; g++) {
    worms[g].dibujarse();
    worms[g].moverse(1);
