...
function vino(){
  ...
  this.mostrar = function(){
    fill (176, 131, 86);
    rect (this.x - this.tam + 20, this.y - 20, this.tam - 40, this.tam - 100);
    fill (27,139,79);
    rect (this.x - this.tam + 25, this.y - 20, this.tam - 50, this.tam);
    rect (this.x - this.tam, this.y, this.tam, this.tam+80);
  }
}
